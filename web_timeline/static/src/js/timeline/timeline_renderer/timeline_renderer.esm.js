...
import {TimelineCanvas} from "../timeline_canvas/timeline_canvas";
import {_t} from "@web/core/l10n/translation";
import {onMounted, useRef} from "@odoo/owl";
import {useService} from "@web/core/utils/hooks";
import {ListRenderer} from "@web/views/list/list_renderer";

export class TimelineRenderer extends ListRenderer {
    async setup() {
    ...
    async initTimeline() {
        ...
        this.timeline = new vis.Timeline(this.timelineRef.el, [], [], options);
     ...
     */
    on_data_loaded(events, group_bys, adjust_window) {
    ...
    on_data_loaded_2(events, group_bys, adjust_window) {
        const data = [];
    ...
    async split_groups(events, group_bys) {
     ...
     * @private
     */
    _trigger(item, callback, trigger) {
