...
export class GroupTimelineArchParser {
...
export class TimelineArchParser {
    parseFieldNode(node, models, modelName) {
        return Field.parseFieldNode(node, models, modelName, "timeline");
    }
    ...
    parse(xmlDoc, models, modelName) {
        ...
        let headerButtons = [];
        const creates = [];
        const groupTimelineArchParser = new GroupTimelineArchParser();
        ...
        visitXML(xmlDoc, (node) => {
            ...
            if (node.tagName === "button") {
                ...
                const groupByArchInfo = groupTimelineArchParser.parse(
                    node,
                    models,
                    coModelName
                );
